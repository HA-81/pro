	...
	<form method="post" action="<c:url value="/connexion" />">
		<fieldset>
			...
			<c:if test="${empty sessionScope.sessionUtilisateur && !empty requestScope.intervalleConnexions }">
				<p class="info">(Vous ne êtes pas sonnecté(e) depuis ce navigateur depuis ${requestScope.intervalleConnexions })</p>
			</c:if>
			...
			<input type="checkbox" id="memoire" name="memoire" /> <br />
