...
public class UtilisateurDaoImpl implements UtilisateurDao {
    ...
    private static final String SQL_SELECT_PAR_EMAIL = "SELECT id, email, nom, mot_de_passe,"
            + "date_inscription FROM Utilisateur WHERE email = ?";
    private static final String SQL_INSERT           = "INSERT INTO Utilisateur (email, mot_de_passe, nom, "
            + "date_inscription) VALUES (?, ?, ?, NOW())";
    ...
    public void creer( Utilisateur utilisateur ) throws DAOException {
        ...
        try {
            ...
            /* Réupération de l'id auto-généré par la requête d'insertion */
